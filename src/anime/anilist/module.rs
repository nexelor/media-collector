...
impl AniListModule {
    ...
    pub async fn queue_fetch_by_mal_id(&self, mal_id: u32) -> Result<(), AppError> {
        self.queue_fetch_by_mal_id_with_options(mal_id, false, false).await
    }
    ...
    pub async fn queue_fetch_by_mal_id_with_pictures(&self, mal_id: u32) -> Result<(), AppError> {
        self.queue_fetch_by_mal_id_with_options(mal_id, true, false).await
    }
    
    /// Queue a full fetch task (base + pictures)
    pub async fn queue_fetch_by_mal_id_full(&self, mal_id: u32) -> Result<(), AppError> {
        self.queue_fetch_by_mal_id_with_options(mal_id, true, true).await
    }
    ...
    pub async fn queue_fetch_by_anilist_id(&self, anilist_id: u32) -> Result<(), AppError> {
        self.queue_fetch_by_anilist_id_with_options(anilist_id, false, false).await
    }
    ...
    pub async fn queue_fetch_by_anilist_id_with_pictures(&self, anilist_id: u32) -> Result<(), AppError> {
        self.queue_fetch_by_anilist_id_with_options(anilist_id, true, false).await
    }
    
    /// Queue a full fetch task (base + pictures)
    pub async fn queue_fetch_by_anilist_id_full(&self, anilist_id: u32) -> Result<(), AppError> {
        self.queue_fetch_by_anilist_id_with_options(anilist_id, true, true).await
    }
